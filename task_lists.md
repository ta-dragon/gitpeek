...
| 項目 | 内容 |
|---|---|
| 直前に完了 | T-11 コミット詳細と変更ファイル一覧（＋ 3 ペインへの配置替え） |
| 次にやる | **T-12 文字コード自動判別**（依存なし。T-13 の前に済ませておく） |
| 未解決の判断事項 | なし |
...
| 3 | 3 | T-09 → T-10 | **済** |
| 4 | 4 | T-11 → **T-12** → T-13 → T-14 | T-11 は**済** |
| 5 | 5 | T-15 / T-16 | 順不同 |
...
| T-11 | 4 | コミット詳細と変更ファイル一覧（＋ 3 ペインへの配置替え） | `f0a7906` |
