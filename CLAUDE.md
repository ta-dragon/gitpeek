...
- [ ] **Phase 4** — コミット詳細 ＋ 変更ファイル一覧 ＋ 差分表示（Shiki / side-by-side / word diff）
- [ ] **Phase 5** — 任意 2 コミット間差分、作業ツリー差分
- [ ] **Phase 6** — fetch / checkout / FF マージ ＋ 各種ガード
- [ ] **Phase 7** — clone
- [ ] **Phase 8** — AI レビュー
- [ ] **Phase 9** — 設定画面、テーマ、ショートカット、エラー処理の仕上げ、配布ビルド

**Phase 2 完了時に「美しいグラフ」の合否を判定する。** 不合格ならレーン割り当てと描線仕様の決定に
戻る。後の Phase を作ってからでは戻れない。
